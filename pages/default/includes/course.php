...
?>
	...
	<div class="row page_title">
		<div class="col_6-inline icon">
			<i class="fas fa-address-card"></i> Cours
		</div>
	...
	<div class="row <?= strtolower($table_name) ?>">
		...
		<?php $values = $ob->find(null,array("order"=>"id ASC","limit"=>array(0,20)),"v_course");  
								...
								<?php
									foreach($columns as $key=>$value){
										if(isset($v[ $columns[$key]["column"] ])){
											...
											if($columns[$key]["column"] == "nbr_article"){ 
												echo "<td style='color:red; font-weight:bold; text-align:center'>0</td>";
											}else{
												echo  "<td>NaN</td>";
											}
										}
