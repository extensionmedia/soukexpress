...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-folder-open"></i> Client Category </span>
	</div>
		...
		<div class="tab-content">
			...
			<?= ($action === "edit")? "<input class='form-element' type='hidden' id='id' value='".$id."'>" : "" ?>
				<div class="row" style="margin-bottom: 20px">
					<div class="col_4">
						<label for="client_category_fr">Catégorie</label>
						<input class="form-element required" type="text" placeholder="Catégorie" id="client_category_fr" value="<?= ($action === "edit")? $data["client_category_fr"] : "" ?>">
					</div>	
					<div class="col_4">
						<label for="client_category_es">Categoria</label>
						<input class="form-element required" type="text" placeholder="Categoria" id="client_category_es" value="<?= ($action === "edit")? $data["client_category_es"] : "" ?>">
					</div>	
					<div class="col_4">
						<label for="client_category_ar">الصنف</label>
						<input class="form-element required" type="text" placeholder="الصنف" id="client_category_ar" value="<?= ($action === "edit")? $data["client_category_ar"] : "" ?>">
					</div>	
				</div>
				<div class="row" style="margin-bottom: 20px">
					<div class="col_6">
