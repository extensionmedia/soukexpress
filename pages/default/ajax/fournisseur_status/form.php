	...
	<div class="panel-content" style="padding: 0px">
		...
		<?= ($action === "edit")? "<input class='form-element' type='hidden' id='id' value='".$id."'>" : "" ?>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_4">
					<label for="client_status_fr">Status (fr)</label>
					<input class="form-element required" type="text" placeholder="Status" id="client_status_fr" value="<?= ($action === "edit")? $data["client_status_fr"] : "" ?>">
				</div>	
				<div class="col_4">
					<label for="client_status_es">Status (es)</label>
					<input class="form-element required" type="text" placeholder="Status" id="client_status_es" value="<?= ($action === "edit")? $data["client_status_es"] : "" ?>">
				</div>
				<div class="col_4">
					<label for="client_status_ar">الحالة</label>
					<input class="form-element required" type="text" placeholder="الحالة" id="client_status_ar" value="<?= ($action === "edit")? $data["client_status_ar"] : "" ?>">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
