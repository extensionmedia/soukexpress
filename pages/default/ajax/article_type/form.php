...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-folder-open"></i> Article Type
	</div>
	...
	<div class="panel-content" style="padding: 0px">
		...
		<?= ($action === "edit")? "<input class='form-element' type='hidden' id='id' value='".$id."'>" : "" ?>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_4">
					<label for="article_type_fr">Status (fr)</label>
					<input class="form-element required" type="text" placeholder="Status" id="article_type_fr" value="<?= ($action === "edit")? $data["article_type_fr"] : "" ?>">
				</div>	
				<div class="col_4">
					<label for="article_type_es">Status (es)</label>
					<input class="form-element required" type="text" placeholder="Typo" id="article_type_es" value="<?= ($action === "edit")? $data["article_type_es"] : "" ?>">
				</div>
				<div class="col_4">
					<label for="article_type_ar">الحالة</label>
					<input class="form-element required" type="text" placeholder="النوع" id="article_type_ar" value="<?= ($action === "edit")? $data["article_type_ar"] : "" ?>">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
