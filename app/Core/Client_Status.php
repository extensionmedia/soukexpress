...
class Client_Status extends Modal{
	...
	private $columns = array(
		...
		array("column" => "client_status_fr", "label"=>"STATUS (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "client_status_es", "label"=>"STATUS (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "client_status_ar", "label"=>"STATUS (ar)", "style"=>"min-width:125px;font-weight:bold"),
