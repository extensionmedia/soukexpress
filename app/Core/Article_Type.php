...
class Article_Type extends Modal{
	...
	private $columns = array(
		...
		array("column" => "article_type_fr", "label"=>"TYPE (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_type_es", "label"=>"TYPE (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_type_ar", "label"=>"TYPE (ar)", "style"=>"min-width:125px;font-weight:bold"),
	...
	private $tableName = "Article_Type";
...
// construct
	...
	public function getColumns(){
		...
		$sort_by = (isset($args['sort_by']))? $args['sort_by']: "article_type_fr";
