...
class Client_Category extends Modal{
	...
	private $columns = array(
		...
		array("column" => "client_category_fr", "label"=>"CATEGORIE (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "client_category_es", "label"=>"CATEGORIE (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "client_category_ar", "label"=>"CATEGORIE (ar)", "style"=>"min-width:125px;font-weight:bold"),
	...
	private $tableName = "Client_Category";
