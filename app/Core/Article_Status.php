...
class Article_Status extends Modal{
	...
	private $columns = array(
		...
		array("column" => "article_status_fr", "label"=>"STATUS (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_status_es", "label"=>"STATUS (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_status_ar", "label"=>"STATUS (ar)", "style"=>"min-width:125px;font-weight:bold"),
	...
	private $tableName = "Article_Status";
...
// construct
	...
	public function getColumns(){
		...
		$sort_by = (isset($args['sort_by']))? $args['sort_by']: "article_status_fr";
