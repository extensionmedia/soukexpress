...
class Article_TVA extends Modal{
	...
	private $columns = array(
		...
		array("column" => "article_tva", "label"=>"TVA", "style"=>"min-width:125px;font-weight:bold"),
...
// construct
	...
	public function getColumns(){
		...
		$sort_by = (isset($args['sort_by']))? $args['sort_by']: "article_tva";
