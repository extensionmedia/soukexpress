...
class Article_UDM extends Modal{
	...
	private $columns = array(
		...
		array("column" => "article_udm_fr", "label"=>"UDM (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_udm_es", "label"=>"UDM (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "article_udm_ar", "label"=>"UDM (ar)", "style"=>"min-width:125px;font-weight:bold"),
...
// construct
	...
	public function getColumns(){
		...
		$sort_by = (isset($args['sort_by']))? $args['sort_by']: "article_udm_fr";
		...
		foreach($values as $k=>$v){
			...
			foreach($columns as $key=>$value){
				...
				if(isset($v[ $columns[$key]["column"] ])){
					...
					}elseif($columns[$key]["column"] == "article_udm_fr"){
						$returned .= "<td style='".$style."'>" . $v["article_udm_fr"] . " (" . $v["ABR_fr"] . ")</td>";
					}elseif($columns[$key]["column"] == "article_udm_es"){
						$returned .= "<td style='".$style."'>" . $v["article_udm_es"] . " (" . $v["ABR_es"] . ")</td>";
					}elseif($columns[$key]["column"] == "article_udm_ar"){
						$returned .= "<td style='".$style."'>" . $v["article_udm_ar"] . " (" . $v["ABR_ar"] . ")</td>";
					}else{
