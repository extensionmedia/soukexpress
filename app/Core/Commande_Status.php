...
class Commande_Status extends Modal{
	...
	private $columns = array(
		...
		array("column" => "commande_status_fr", "label"=>"STATUS (fr)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "commande_status_es", "label"=>"STATUS (es)", "style"=>"min-width:125px;font-weight:bold"),
		array("column" => "commande_status_ar", "label"=>"STATUS (ar)", "style"=>"min-width:125px;font-weight:bold"),
	...
	private $tableName = "Commande_Status";
...
// construct
	...
	public function drawTable($args = null, $conditions = null, $useTableName = null){
		...
		$sort_by = (isset($args['sort_by']))? $args['sort_by']: "client_status_fr";
		...
		foreach($values as $k=>$v){
			...
			$background = $v["color"]!==""? " style='background-color:" . $v["color"] . "' ": "";
			
			$returned .= '					<tr '.$background.' class="edit_ligne" data-page="'.$_t.'">';
			foreach($columns as $key=>$value){
...
$commande_status = new Commande_Status;